...
#tag WindowCode
	#tag Event
		Sub Opening()
		  ...
		  Biglabel.AddBadge("huge", WebUIControl.Indicators.Success)
		  
		  SmallLabel.AddBadge("but", WebUIControl.Indicators.Danger)
		  SmallLabel.AddBadge("can", WebUIControl.Indicators.Warning)
